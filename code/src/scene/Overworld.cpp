	...
	game_camera(sf::FloatRect(0, 0, 800, 600))
{
	...
	main_character.sprite.setPosition(tiled2Sfml.coordToPosition(0, 0));
	log->info("pos x{} y{}", main_character.sprite.getPosition().x, main_character.sprite.getPosition().y);
	render.clear();
